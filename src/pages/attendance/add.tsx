import { Avatar, Box, Button, Center, color, Flex, HStack, Input, Stack, Text, useToast, VStack } from '@chakra-ui/react'
...
const Add = ({members}) => {
  ...
  const [newAttendance, { isLoading, data, isError, error, isSuccess }] = useAddAttendanceMutation()
  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <Flex justifyContent="center" flexDirection="column" gap="6" alignItems="center" w="48%" bg="white" shadow="base" mx="auto" p="3rem">
          <Text fontSize="2xl" fontWeight="semibold" color="primary">
            {currentTime}
          </Text>
          <Box w="100%">
            <DatalistInput
              listboxProps={{ style: { maxHeight: '250px', overflowY: 'auto' } }}
              label=""
          ...
          <Button colorScheme="blue" fontWeight="normal" onClick={handleSubmit} isLoading={isLoading}>
            Mark Present
          </Button>
        </Flex>
      </Box>
